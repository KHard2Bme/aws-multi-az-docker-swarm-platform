...
### 1. Add Automated Failure Testing

Use AWS Systems Manager Run Command or a controlled automation workflow to execute repeatable failure scenarios.

### 2. Add CloudWatch Alarm Runbooks

Create a runbook for each alarm containing:
...
This would provide a cleaner and more intentional ALB health-check target.

### 4. Add Centralized Dashboard Screenshots
...
### 6. Consider Terraform Modules

As the project grows, separate reusable components:
...
### 7. Add a Post-Failure Report

For every failure test, document:
